...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            /*
            Метод hasNextInt() проверяет, является ли следующий ввод целым числом.
            Если это так, то метод nextInt() считывает это число
             */
            if (scanner.hasNextInt()) {
                int no = scanner.nextInt();
                /*
                Этот дополнительный вызов nextLine() может быть использован для
                "очистки" символа новой строки (\n), который остается после
                считывания целого числа методом nextInt(). Если ввести "1 аапвам"
                то программа распознает строку как 1.
                 */
                scanner.nextLine();
                switch (no) {
                    case 0 -> {
